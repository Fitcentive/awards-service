...
== Description
A reactive/rest microservice to handle and serve data pertaining to awards, achievements and progress
...
- `gcloud container images delete gcr.io/fitcentive-dev-03/awards:1.0 --force-delete-tags`
